...
const EditorStatusBar: React.FC<EditorStatusBarProps> = ({
  ...
  <footer className="h-7 bg-zinc-100 dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-between px-3 text-[10px] font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-500 flex-shrink-0 z-40">
    <div className="flex items-center gap-5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-zinc-400">Auto-Compile</span>
      ...
      {repoCompilationResult && (
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-zinc-400">Last Build</span>
    ...
    <div className="flex items-center gap-5">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-zinc-400">Open Tabs</span>
